...
exports.streamVideoHandler = exports.findVideosHandler = exports.updateVideoHandler = exports.uploadVideoHandler = void 0;
...
const updateVideoHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        ...
        if (((_a = video.owner) === null || _a === void 0 ? void 0 : _a.toString()) !== userId.toString()) {
...
const findVideosHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const streamVideoHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { videoId } = req.params;
